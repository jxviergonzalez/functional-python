# Functional Python [![](https://github.com/jxviergonzalez/functional-python/workflows/tests/badge.svg)](https://github.com/jxviergonzalez/functional-python/actions?query=workflow%3Atests)
